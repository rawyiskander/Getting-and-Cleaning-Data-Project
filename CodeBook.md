...
This is a code book that describes the variables, data, and any transformations or work that I performed to clean up the data.
...
__Get label variables appropriately__
